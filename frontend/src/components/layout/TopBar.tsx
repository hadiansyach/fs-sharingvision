  ...
  return (
    <header className="flex justify-between items-center h-16 px-margin-mobile md:px-margin-desktop md:ml-[280px] bg-surface-container-lowest text-primary font-title-lg text-title-lg border-b border-outline-variant sticky top-0 z-30">
      <div className="flex items-center gap-sm">
        <Link to="/posts" className="font-headline-md text-headline-md font-bold text-primary">
          ArticleFlow
        </Link>
      </div>
      <div className="flex items-center gap-lg">
        <div className="relative hidden sm:block">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="pl-xl pr-sm py-xs bg-surface-container border border-outline-variant rounded-full text-body-md font-body-md focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary w-64 transition-all"
          />
        </div>
